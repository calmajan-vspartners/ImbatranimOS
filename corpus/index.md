...
- [backlog-2026-08-07](wiki/backlog-2026-08-07.md) — The 2026-08-07 research-sweep backlog — briefs 101-136, one line each, from five parallel code-exploration lenses (deferral harvest, shell UX, app depth, platform resilience, fit-and-finish). Ordered in build waves; each row names its evidence class. All ungrilled proposals; grill before building.
...
- [decisions-pivot-era](wiki/decisions-pivot-era.md) — The 2026-07-16 web-OS-era and 2026-07-17 Office/post-v1 decisions, still locked — the single-container shape, the add-on contract, the app roster and the Office-suite scope. Split out of decisions.md on 2026-08-05, which has a 200-line cap.
...
- [feature-exploration-2026-08-06](wiki/feature-exploration-2026-08-06.md) — The 2026-08-06 feature-exploration sweep — code map + external landscape (Puter, daedalOS, AnuraOS, CasaOS/Umbrel) distilled into seven briefs (93-99, ALL BUILT the same day — see each brief's outcome note), a cheap-wins list, a grill-first tier with the contentious questions named, and what was deliberately NOT proposed because real-os-gaps.md already rejected it.
